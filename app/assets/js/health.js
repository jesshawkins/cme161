...
d3.json("https://warm-cliffs-73390.herokuapp.com/health", function(remote_json){
  ...
  var dim_flights_climbed  	= cf.dimension(function(d){return d.flights_climbed; }); 
  var dim_distance_mi   	= cf.dimension(function(d){return d.distance_mi; }); 
  var dim_distance_km       = cf.dimension(function(d){return d.distance_km;});
  ...
  // groups
  var date_steps = dim_date.group().reduceSum(function(d){ return d.steps; });
  var date_hr  = dim_date.group().reduceSum(function(d){ return d.sepal_width; });
